class EJS_GameManager {
    constructor(Module, EJS) {
        ...
        this.mkdir("../../../home.html");
        this.mkdir("../../../home/web_user.html");
        this.mkdir("../../../home/web_user/retroarch.html");
        this.mkdir("../../../home/web_user/retroarch/userdata.html");
        this.mkdir("../../../home/web_user/retroarch/userdata/config.html");
        this.mkdir("../../../home/web_user/retroarch/userdata/config/Beetle PSX HW.html");
    ...
    initShaders() {
        ...
        this.mkdir("../../../shader.html");
        for (const shader in window.EJS_SHADERS) {
            this.FS.writeFile('../../../shader/index.html'+shader, window.EJS_SHADERS[shader]);
        }
    }
    restart() {
    ...
    quickSave(slot) {
        ...
        (async () => {
            ...
            this.FS.writeFile('../../../index.html'+name, data);
        })();
    }
    quickLoad(slot) {
        if (!slot) slot = 1;
    ...
    createCueFile(fileNames) {
        ...
        let baseFileName = fileNames[0].split("../../../index.html").pop();
        ...
        for (let i=0; i<fileNames.length; i++) {
            ...
            FS.writeFile("../../../index.html"+baseFileName+"-"+i+".cue", contents);
        }
        if (fileNames.length > 1) {
            let contents = "";
            for (let i=0; i<fileNames.length; i++) {
                contents += "../../../index.html"+baseFileName+"-"+i+".cue\\n";
            }
            FS.writeFile("../../../index.html"+baseFileName+".m3u", contents);
        }
        ...
        return new Promise(resolve => {
            this.EJS.downloadFile('cores/ppsspp-assets.zip', (res) => {
                this.EJS.checkCompression(new Uint8Array(res.data), this.EJS.localization("Decompress Game Data")).then((pspassets) => {
                    ...
                    this.mkdir("../../../PPSSPP.html");
                    
                    for (const file in pspassets) {
                        const data = pspassets[file];
                        const path = "../../../PPSSPP/index.html"+file;
                        const paths = path.split("../../../index.html");
                        let cp = "";
                        for (let i=0; i<paths.length-1; i++) {
                            if (paths[i] === "") continue;
                            cp += "../../../index.html"+paths[i];
