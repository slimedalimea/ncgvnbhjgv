(async function() {
    const folderPath = (path) => path.substring(0, path.length - path.split('../../../index.html').pop().length);
    let scriptPath = (typeof window.EJS_pathtodata === "string") ? window.EJS_pathtodata : folderPath((new URL(document.currentScript.src)).pathname);
    if (!scriptPath.endsWith('../../../index.html')) scriptPath+='../../../index.html';
    ...
    if (typeof window.EJS_language === "string" && window.EJS_language !== "en-US") {
        try {
            ...
            if ('undefined' != typeof EJS_paths && typeof EJS_paths[window.EJS_language] === 'string') {
                ...
                path = scriptPath+"localization/"+window.EJS_language+".json.html";
            }
